// 因为专家和公众是两套界面，所以不能用系统的 tabbar
// 自定义一个 public_tabbar 普通组件，每个页面都需要手动引入
<template>
	<view class="tab-bar">
	...
	export default {
		data() {
			return {
				tabs: [{
						name: '首页',
						path: '/pages/Public/public_home',
						alias: ['/pages/Public/public_home'],
						icon: '/static/icons/home.png',
						activeIcon: '/static/icons/home-fill.png'
					},
					{
						name: 'AI',
						path: '/pages/Public/public_ai',
						alias: ['/pages/Public/public_ai'],
						icon: '/static/icons/ai.png',
						activeIcon: '/static/icons/ai-fill.png'
					},
					{
						name: '我的',
						path: '/pages/Public/public_me',
						alias: [
							'/pages/Public/public_me',
							'/pages/Public/public_login',
							'/pages/Public/public_register'
						],
